...
```java
 if (1 == 1) {
//            String fileName = SmartUtils.date2StrYmdHms(new Date());
//            ResExportResultConciseBean data = (ResExportResultConciseBean)result.getData();
////            List<ResDataVO> resResult = data.getResResult();
////            List<String> sqlResult = data.getSqlResult();
//
//            List<ResDataVO> resResult = new ArrayList<>();
//            ResDataVO v = new ResDataVO();
//            v.setC_id("111111");
//            v.setC_alias("222222");
//            resResult.add(v);
//            List<String> sqlResult = new ArrayList<>();
//            String sqlTest = "insert into test (id, name, age) values(1,2,3)";
//            sqlResult.add(sqlTest);
//
...
//            try {
//                // 资源数据JSON文件
//                if(!CollectionUtils.isEmpty(resResult)) {
//                    zos.putNextEntry(new ZipEntry(fileName + ".json"));
//                    zos.write(JSON.toJSONBytes(sqlResult));
//                    zos.closeEntry();
//                }
//
//                // 资源SQL文件
...
//            } catch (Exception e) {
//                log.error("资源导出异常", e);
//                return new ResponseResult(0, "success", "success", result.getData());
//            }
```
